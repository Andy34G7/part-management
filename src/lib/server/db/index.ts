import { PostgresDropdownRepository, PostgresForm1Repository, PostgresForm2Repository, PostgresBelbinRepository } from './postgres';
...
export const belbinRepository = new PostgresBelbinRepository();
